    ...
    <body>
        ...
        <main>
            @if (!empty($pasta_lng['lunga']))
                <h2>LE LUNGHE</h2>
                @foreach ($pasta_lng['lunga'] as $key => $card)     {{-- mostra la pasta specificata --}}
                    <div class="card">
                        <div class="card-img">
            ...
            @if (!empty($pasta_lng['corta']))
                <h2>LE CORTE</h2>
                @foreach ($pasta_lng['corta'] as $key => $card)     {{-- mostra la pasta specificata --}}
                    <div class="card">
                        <div class="card-img">
                            <img src="{{$card['src']}}" alt="{{$card['titolo']}}">
                        </div>
            ...
            @if (!empty($pasta_lng['cortissima']))
                <h2>LE CORTISSIME</h2>
                @foreach ($pasta_lng['cortissima'] as $key => $card)        {{-- mostra la pasta specificata --}}
                    <div class="card">
                        <div class="card-img">
                            <img src="{{$card['src']}}" alt="{{$card['titolo']}}">
                        </div>
